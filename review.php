  ...
  <div class="container">
    <div class="card" style="max-width:900px;margin:0 auto">
            ...
            <?php foreach ($features as $f): ?>
              <tr>
                ...
                <td>
                  ...
                  <?= $val ? '<span class="ltr-value">'.e($val).'</span>' : ($f['is_included'] ? '<span class="yes">&#10003;</span>' : '<span class="no">&#10007;</span>') ?>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
          ...
          <div class="coupon-card" style="margin-bottom:12px">
            ...
            <div style="display:flex;align-items:center;gap:12px">
              <button type="button" class="coupon-cta"
                      data-copy="<?= e($cp['code']) ?>"
                      data-goto="go.php?company=<?= e($c['slug']) ?>&coupon=<?= (int)$cp['id'] ?>"
      ...
      <div class="actions" style="margin-top:24px">
        <div class="price" style="font-size:20px"><?= t('company.starting_at') ?> <span class="ltr-value"><?= e($c['starting_price']) ?></span></div>
